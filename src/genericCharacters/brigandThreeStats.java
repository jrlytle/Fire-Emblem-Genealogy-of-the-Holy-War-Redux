...
public class brigandThreeStats
{
  ...
  hammerStats h = new hammerStats();
  genItem hammer = new genItem(h.allStats, new boolean[] {true,false,false,false,false,false,false,false,false,false,false});
  
  final static Random r = new Random();
  public int team = 2;
  public int characterID = 160;
  ...
  public item[] weapons = new item[] {hammer,nW,nW,nW,nW,nW,nW};
