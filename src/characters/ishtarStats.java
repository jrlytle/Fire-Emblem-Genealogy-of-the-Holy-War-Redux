...
public class ishtarStats
{
  ...
  public int team = 2;
  public int characterID = 115;
  public int classID = 74;
  public int baseClass = 29;
  public int level = 15;
  public int maxLevel = 20;
  public int exp = 0;
  public int[] currentStats = new int[] {42,42,10,34,38,41,18,17,28,6};
  ...
  public int[] weaponEXP = new int[] {0,0,0,0,0,71,71,251,71,71,0,0};
  public int[] skills = new int[] {4,8,77,78,79,80};
  ...
  public item[] weapons = new item[] {thorhammer,nW,nW,nW,nW,nW,nW}; //Need to change to inherit thorhammer from Blume
