...
public class feeFeminaStats //This Character's Mother is Fury
{
  ...
  berserkSwordStats b = new berserkSwordStats();
  genItem berserkSword = new genItem(b.allStats, b.remainingStats);
  public int team = 0;
  ...
  int[] defaultSkills = new int[] {4,65,0,0,0,0};
  ...
  public item[] weapons = new item[] {slimLance,berserkSword,nW,nW,nW,nW,nW};
  ...
  public int[] getPercents()
  {
    ...
    {
      return new int[] {600,300,100,200,500,500,200,50};
    }
  }
  public int[] getCurrentStats()
  {
    ...
    {
      return new int[] {28,28,11,2,11,16,3,8,10,8};
    }
  }
  public int getGold()
  {
