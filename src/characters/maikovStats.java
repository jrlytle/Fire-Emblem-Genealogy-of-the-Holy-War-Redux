...
public class maikovStats
{
  ...
  genItem killerBow = new genItem(k.allStats, k.remainingStats);
  public int team = 2;
  ...
  public int exp = 0;
  public int[] currentStats = new int[] {64,64,34,4,25,21,0,35,10,5};
  ...
  public item[] weapons = new item[] {silverLance,killerBow,nW,nW,nW,nW,nW};
