...
public class johanStats
{
  ...
  public int team = 2;
  public int characterID = 97;
  public int classID = 6;
  public int baseClass = 6;
  public int level = 12;
  public int maxLevel = 20;
  public int exp = 0;
  public int[] currentStats = new int[] {40,40,18,0,12,14,5,15,2,8};
  //Baldo, Odo, Hezul, Noba, Dain, Neir, Ulir, Blagi, Fala, Tordo, Holsety, Narga, Loputousu
  public int[] bloodTypePercents = new int[] {0,0,0,0,0,16,0,0,0,0,0,0,0};
  public int[] basePercents = new int[] {900,400,50,200,500,100,300,50};
  ...
  public int[] skills = new int[] {8,0,0,0,0,0};
