...
public class johalvaStats
{
  ...
  public int team = 2;
  public int characterID = 96;
  public int classID = 19;
  public int baseClass = 19;
  public int level = 12;
  public int maxLevel = 20;
  public int exp = 0;
  public int[] currentStats = new int[] {42,42,20,0,10,16,5,15,2,6};
  //Baldo, Odo, Hezul, Noba, Dain, Neir, Ulir, Blagi, Fala, Tordo, Holsety, Narga, Loputousu
  public int[] bloodTypePercents = new int[] {0,0,0,0,0,16,0,0,0,0,0,0,0};
  public int[] basePercents = new int[] {900,400,0,500,100,100,300,50};
  ...
  public int[] skills = new int[] {9,46,47,0,0,0};
  ...
  public item[] weapons = new item[] {steelAxe,nW,nW,nW,nW,nW,nW};
