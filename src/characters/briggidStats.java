...
public class briggidStats
{
  ...
  steelBowStats s = new steelBowStats();
  genItem steelBow = new genItem(s.allStats, new boolean[] {true,false,false,false,false,false,false,false,false,false,false});
  public int team = 0;
  public int characterID = 19;
  public int classID = 53;
  public int baseClass = 23;
  public int level = 12;
  public int maxLevel = 20;
  public int exp = 0;
  public int[] currentStats = new int[] {40,40,30,0,39,31,11,25,16,6};
  //Baldo, Odo, Hezul, Noba, Dain, Neir, Ulir, Blagi, Fala, Tordo, Holsety, Narga, Loputousu
  public int[] bloodTypePercents = new int[] {0,0,0,0,0,0,24,0,0,0,0,0,0};
  public int[] basePercents = new int[] {750,450,300,450,300,150,300,75};//new int[] {500,300,200,300,200,100,200,50};
  public int[] bonusPercents = rBT.getBloodPercent(bloodTypePercents);
  //0->1 "-", 1->30 "D", 30->70 "C", 70->120 "B", 120->180 "A", 180->250 "S"
  public int[] weaponEXP = new int[] {0,0,0,251,0,0,0,0,0,0,0,0};
  ...
  public item[] weapons = new item[] {steelBow,nW,nW,nW,nW,nW,nW};
