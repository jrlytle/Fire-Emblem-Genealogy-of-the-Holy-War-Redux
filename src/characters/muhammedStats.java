...
public class muhammedStats
{
  ...
  heroLanceStats h = new heroLanceStats();
  genItem heroLance = new genItem(h.allStats, new boolean[] {true,false,false,false,false,false,false,false,false,false,false});
  heroBowStats hB = new heroBowStats();
  genItem heroBow = new genItem(hB.allStats, hB.remainingStats);
  public int team = 2;
  public int characterID = 113;
  public int classID = 54;
  public int baseClass = 8;
  public int level = 17;
  public int maxLevel = 20;
  public int exp = 0;
  public int[] currentStats = new int[] {65,65,34,4,25,21,0,35,10,5};
  ...
  public item[] weapons = new item[] {heroLance,heroBow,nW,nW,nW,nW,nW};
